/**
 * $Id: mxGraphOutline.java,v 1.22 2010-05-31 08:49:27 gaudenz Exp $
...
public class mxGraphOutline extends JComponent
{
	...
	/**
	 * Fires a property change event for <code>taskComponent</code>.
	 * 
	 * @param graphComponent the taskComponent to set
	 */
	public void setGraphComponent(mxGraphComponent graphComponent)
	{
		...
		firePropertyChange("taskComponent", oldValue, graphComponent);
	}
