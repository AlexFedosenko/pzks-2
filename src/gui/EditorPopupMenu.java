...
public class EditorPopupMenu extends JPopupMenu {
    ...
    public EditorPopupMenu(BasicGraphEditor editor) {
        boolean selected = !editor.getTaskComponent().getGraph().isSelectionEmpty();
        ...
        add(
                editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(),
                "/com/mxgraph/examples/swing/images/cut.gif")).setEnabled(selected);
        add(
                editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(),
        ...
        add(
                editor.bind(mxResources.get("edit"), mxGraphActions.getEditAction())).setEnabled(selected);
